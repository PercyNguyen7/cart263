// This small timer moves from the left to the right. Once it reaches the right end of the rectangle, Voldemort will cast his spell - Stage 4
class Timer {
  constructor(timerImage) {
    // Properties of the Slytherin House image
    this.x = 50,
      this.y = 450,
      this.vx = 0;
    this.width = 40,
